...
export const emulator_set_edx: (a: number, b: number) => void;
export const emulator_set_ebp: (a: number, b: number) => void;
export const emulator_set_esp: (a: number, b: number) => void;
